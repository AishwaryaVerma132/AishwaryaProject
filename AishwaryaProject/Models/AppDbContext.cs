...
namespace AishwaryaProject.Models
{
    public class AppDbContext : DbContext
    {
        ...
        // OnModelCreating is used to inject/seed the initial data
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            base.OnModelCreating(modelBuilder);

            //seed students  i.e adding students to the database
            ...
            modelBuilder.Entity<Student>().HasData(
                ...
                new Student{StudentID=16, FirstName="Vaibhav",LastName="Bhatnagar",Age=22, Gender="M", TeamName="D" },
